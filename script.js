...
console.log("i = " + i + " length=" + numArray[i].length + "
num[i]=" + numArray[i])
//go to proper converter depending on number of digits in array
// if array is not filled with 0's
if(numArray[i][0] !== "000"){
//numArray[i][0] represents the string value of the
3-digit-or-less block
...
twoDigitOrLessConvert(parseInt(num.toString().substr(1)));
}
return currentNumText;
}
/**
